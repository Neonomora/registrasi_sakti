            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">ahmad syaifulloh</span>
              </a>
            ...
            >
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= base_url('adminlte/dist/');?>index.html" class="nav-link active">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('adminlte/dist/');?>layout/fixed-sidebar.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Fixed Sidebar</p>
                    </a>
                  </li>
